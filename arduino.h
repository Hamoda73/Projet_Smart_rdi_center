...
private:
QSerialPort* serial; //Cet objet rassemble des informations (vitesse, bits de données, etc.) //et des fonctions (envoi, lecture de réception,...) sur ce qu'est une voie série pour Arduino. static const quint16 arduino_uno_vendor_id=9025;
